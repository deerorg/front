<template>
    <div class="systentantresourceresource">
    <div class="systentantresourceresource__filter-container p-filter-container">
    ...
    <section class="systentantresourceresource__table">
...
export default {
  name: "systentantresourceresource",
  data() {
    return {
      rawList: [],
      list: [],
