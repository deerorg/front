<template>
  <div class="monitoringIndex4">
    <div class="monitoringIndex4__left">
    <el-row type="flex" class="row-bg">
        <el-col :span="12"><div class="grid-content bg-purple">
        <e-player :size="size"   :ipc="ipc" v-if="isShowIpc" player-id="infore_ipc_40"  @on-choose-player="onChoosePlayer"></e-player>
        </div>
        </el-col>
        <el-col :span="12">
            <div class="grid-content bg-purple-light">
                <e-player :size="size"     :ipc="ipc2" v-if="isShowIpc2"  player-id="infore_ipc_41"  @on-choose-player="onChoosePlayer"></e-player>
            </div>
        </el-col>
    </el-row>
    <el-row type="flex">
        <el-col :span="12"><div class="grid-content bg-purple">
        <e-player  :size="size"   :ipc="ipc3" v-if="isShowIpc3" @on-choose-player="onChoosePlayer"  player-id="infore_ipc_42" ></e-player>
        </div>
        </el-col>
        <el-col :span="12">
            <div class="grid-content bg-purple-light">
                <e-player :size="size"    :ipc="ipc4" v-if="isShowIpc4" @on-choose-player="onChoosePlayer"  player-id="infore_ipc_43" ></e-player>
            </div>
        </el-col>
    </el-row>
