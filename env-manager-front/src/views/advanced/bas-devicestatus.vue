<template>
    <div class="basdevicestatus">
    <div class="basdevicestatus__filter-container p-filter-container">
    ...
    <section class="basdevicestatus__table">
...
export default {
  ...
  methods: {
    ...
    handleDelete(index, row) {
      const me = this
      deleteItem("/devicestatus/", { "devicestatus": row.devicestatus }).then(response => {
        const { success, data, msg } = response.data
        if (success) {
    ...
    confirmModify() {
      ...
      me.$refs.modifyForm.validate(valid => {
        if (valid) {
          modifyItem('/devicestatus/', me.modifyForm)
            .then(response => {
              const { success, data, msg } = response.data
    ...
    confirmAdd() {
      ...
      me.$refs.addForm.validate(valid => {
        if (valid) {
          addItem('/devicestatus/', me.addForm)
            .then(response => {
              const { success, data, msg } = response.data
